...
public class Zyto_Variance implements PlugInFilter {
	...
	public void run(ImageProcessor ip) {
		...
		ImagePlus outputImage = NewImage.createByteImage("Blue Channel Image", colorProcessor.getWidth(), colorProcessor.getHeight(), 1, NewImage.FILL_WHITE);
	...
	public static void main(String[] args) {
		...
		//        URL url = Zyto_Variance.class.getClassLoader().getResource("pic/Inet2.jpg");
